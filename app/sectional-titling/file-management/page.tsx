...
export default function FileNoManagementPage() {
  ...
  return (
    <AppShell
      title="ST FileNo Management"
      subtitle="View, search, and manage all Sectional Titling file numbers."
      metrics={[]}
    >
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold tracking-tight">ST FileNo Management</h2>
      ...
      <Modal
        ...
        title="Commission New ST FileNo"
